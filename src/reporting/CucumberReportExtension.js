...
CucumberReportExtension.jsonDir = process.cwd() + "\\src\\reporting\\json";
CucumberReportExtension.htmlDir = process.cwd() + "\\src\\reporting\\html";
CucumberReportExtension.jsonFile = CucumberReportExtension.jsonDir + "\\cucumber_report.json";
CucumberReportExtension.cucumberReportOptions = {
    theme: 'bootstrap',
